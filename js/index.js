...
function onDeviceReady(){
    ...
    // Platform-specific
    document.querySelector('body').classList.add(cordova.platformId);
...
var checkAutoInit = function(){
    FirebasePlugin.isAutoInitEnabled(function(enabled){
        ...
        document.querySelector('body').classList.add('autoinit-' + (enabled ? 'enabled' : 'disabled'))
        document.querySelector('body').classList.remove('autoinit-' + (enabled ? 'disabled' : 'enabled'));
    }, function(error) {
