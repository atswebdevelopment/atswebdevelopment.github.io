...
function register_theme_scripts() {
  if (!is_admin()) {
    wp_register_script('ss-stellar', get_template_directory_uri() . '/js/vendor/jquery.stellar.min.js', array('jquery'), false, true);
    wp_register_script('ss-main', get_template_directory_uri() . '/dist/main.js', array('jquery', 'ss-stellar'), '2.4', true);
    wp_enqueue_script('ss-main');
  }
}
